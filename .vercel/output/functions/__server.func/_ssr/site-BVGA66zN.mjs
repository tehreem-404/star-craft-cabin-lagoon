...
//#region node_modules/.nitro/vite/services/ssr/assets/site-BVGA66zN.js
function cn(...inputs) {
...
var rooms = [
	{
		...
		gallery: [
			"/images/suite-caldera.jpg",
			"/images/pool.jpg",
			"/images/hero.jpg"
		],
		blurb: "The original belvedere. Lime, linen, a wrap of windows, and the whole cove below.",
		description: "The largest room in the house sits at the old lookout, where the cliff turns and the sea fills the frame. A long room of limewash and pale oak, a terrace that holds the afternoon, and a soaking tub cut from the same stone as the path down to the water. Evenings are for the shutters half-drawn and the sound of cicadas giving way to the tide.",
		amenities: [
			"Private sea terrace",
			"Deep stone tub",
	...
	},
	{
		...
		gallery: [
			"/images/suite-olive.jpg",
			"/images/path.jpg",
			"/images/spa.jpg"
		],
		blurb: "On the landward side, among the trees that give the room its name. Morning light, terracotta underfoot.",
		description: "Olive looks into the grove rather than the sea — silver leaves, dry-stone walls, the smell of crushed herb when the wind comes down the hill. Terracotta underfoot, limewashed walls, a terrace for coffee before the house is fully awake. A quieter room, for those who come to read and walk.",
		amenities: [
			"Garden terrace",
			"Queen bed",
			"Writing desk",
	...
	},
	{
		...
		gallery: [
			"/images/suite-luna.jpg",
			"/images/pool.jpg",
			"/images/dining.jpg"
		],
		blurb: "A small house of its own. Two floors, a plunge of still water, the coast at dusk.",
		description: "Luna is a house within the house: a sitting room that opens onto a private plunge, a bedroom above, and stone steps down to the shared path. Lamps go on at dusk and the water holds the last of the sky. For longer stays, or for two who want a door of their own.",
		amenities: [
			"Private plunge pool",
			"Two floors",
			"King bed and daybed",
	...
	},
	{
		...
		gallery: [
			"/images/suite-cliff.jpg",
			"/images/hero.jpg",
			"/images/path.jpg"
		],
		blurb: "The original room. Narrow, white, a window the size of the sea. For those who come to swim.",
		description: "The first room we opened, and still the one guests ask for by the window. A compact studio of lime plaster and striped linen, a worn desk, and a single opening that frames deep water. Nothing extra. The path to the cove starts ten metres from the door.",
		amenities: [
			"Sea window",
			"Queen bed",
			"Writing desk",
...
//#endregion
export { menu as a, viewLabels as c, houseNotes as i, experiences as n, rooms as o, formatEuro as r, site as s, cn as t };
